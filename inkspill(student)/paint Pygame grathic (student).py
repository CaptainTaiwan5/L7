...
def main():
    ...
    while True:
        ...
        #範例：pygame.draw.line(screen, BLACK, [0,0], [100,200], 10)
        
        #pygame.draw.rect(畫布, 顏色, [x坐標, y坐標, 寬度, 高度], 線寬)
        #範例：pygame.draw.rect(screen, COPPER, [250,50,120,80])

        #pygame.draw.circle(畫布, 顏色, (x坐標, y坐標), 半徑, 線寬)
        #範例：pygame.draw.circle(screen, GOLD, [600,100], 60)

        #pygame.draw.ellipse(畫布, 顏色, [x坐標, y坐標, x直徑, y直徑], 線寬)
        #範例：pygame.draw.ellipse(screen, RED, (200, 250, 160, 100))
